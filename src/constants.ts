...
export const PROJECTS: Project[] = [
	{
		...
		description:
			"A scientific research on how dictionaries can help reducing time and improving quality, when detecting political content and running local LLM's to analyse exposure. Also includes an App that tracks political content exposure live.",
		link: 'https://github.com/noah-hrbth/lolap',
		tags: ['LLM', 'Political Content Detection', 'Python'],
	},
	{
		id: 'token-saver',
	...
	{
		id: 'agentsync',
		label: 'Agent Tool Sync',
		description:
			'A TUI that helps you keep multiple AI tools like Claude Code, Codex, Gemini CLI etc. in sync. You can add, remove and edit rules, subagents, skills and sync them from the tool to your chosen AI tools',
		link: 'https://github.com/noah-hrbth/agent-tool-sync',
		tags: ['AI', 'TUI', 'Go'],
	},
	/*
	{
